...
- Renders basic text formatting from Visio `Color`, `Font`, `Size`, `Character.Style`, `DblUnderline`, `Strikethru`, paragraph alignment, bullet text position, TextBlock margins, `TextBkgnd`, and `TextBkgndTrans` cells, including inherited formatting from styles and legacy Visio XML files.
