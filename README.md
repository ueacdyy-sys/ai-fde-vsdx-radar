...
- Renders connector direction and line semantics from Visio `BeginArrow`, `EndArrow`, and `LinePattern` cells, including modern package and legacy Visio XML files.
