...
- Renders basic text formatting from Visio `Color`, `Size`, `Character.Style`, paragraph alignment, TextBlock margins, `TextBkgnd`, and `TextBkgndTrans` cells, including inherited formatting from styles and legacy Visio XML files.
